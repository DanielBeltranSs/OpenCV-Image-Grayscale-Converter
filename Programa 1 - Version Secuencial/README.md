1.  Para comenzar la ejecucion del primer programa "Programa1-Version Secuencial", es necesario entrar dentro de la carpeta mediante la terminal y ejecutar el comando "make".
